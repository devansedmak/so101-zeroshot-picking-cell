...
- `homography.npz` + `homography-notes.md` — overhead camera→table plane calibration (checkerboard corners, reprojection error, date; recalibrate if the camera moves)
