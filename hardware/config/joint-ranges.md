...
⇒ **LOW = SHUT, HIGH = OPEN**, mapped straight onto the follower's calibrated `0° → 128.9°`. Option 2
...
| `DEFAULT_JOINT_LIMITS["6"]` | ±60° | **0 → 124** | same ~5° margin as every other joint; ±60 was doubly wrong — it admitted negative angles the servo does not have, and capped "open" at 60°, i.e. *half closed* |
